            ...
            .extend(
                "reference.controller.Overview", {
                    ...
                    combo: function() {
                        ...
                        var oMultiInput2 = this.getView().byId("multiInput1");
                        oMultiInput2.addToken(new sap.m.Token({
                            text: combo
                        }));
                    ...
                    handleChange: function(oEvent) {
                        ...
                        var m = this.getView().byId("DTP1").getDateValue();
                    ...
                    onInit: function(evt) {
                        ...
                        //				var Service_URL = location.hostname ? "proxy/http/152.63.2.109:8001/sap/opu/odata/sap/" : "/sap/opu/odata/sap/";
                        ...
                        if (window.HRssapprovesearchFrag == undefined) {
                            window.HRssapprovesearchFrag = sap.ui.xmlfragment("reference/Fragments/overviewSearch", sap.ui.controller("reference.controller.Overview"));
                        }
                        HRssapprovesearchFrag.open();
                        ...
                        var indexModel = new sap.ui.model.json.JSONModel(indData);
                        ...
                        var oPicker = this.byId("datePicker");
                        ...
                        //			var finApprTable = new sap.ui.model.odata.ODataModel(`proxy/http/services.odata.org/V3/Northwind/${serviceName}.svc/`);


                        var finApprTable = new sap.ui.model.odata.v2.ODataModel($.sap.Service_URL);
                    ...
                    onAfterRendering: function() {
                        ...
                        var min = addMonths(new Date(), -6);
                        var max = addMonths(new Date(), +6);
                        var minMM, minDD, minYY, maxMM, maxDD, maxYY;
                        minMM = min.getMonth();
                        minDD = min.getDate();
                        ...
                        //				var iid = "#"+this.getView().byId("two").getId();
                        ...
                        var tx = "#" + this.getView().byId("text").getId();
                        $(tx).click(function() {
                            alert("txtxtx");
                        });

                        var datett = this.getView().byId("getDate");
                        console.log(datett);




                        //var inp = this.getView().byId("getDate").getId();
                        //$("#"+inp).click(function(){
                        //	alert("hi");
                        //});
                    ...
                    button: function() {
                        var a = this.getView().byId("one").getValue();
                        var b = this.getView().byId("two").getValue();
                        var c = +a + +b;
                        var m = this;
                        console.log(m);
                        ...
                        //
                        //var $a = $(this.getView().byId("getDate").getDomRef().id);
                        //
                        //console.log(oCtx , $a);

                        //console.log(this.getView().byId("getDate").getValue(), this.oModel.getData());
                        //var m = this.getView().byId("table").getColumns();
                    ...
                    tableModel: function() {
                        ...
                        var hasModel = this.getView().byId("table").hasModel();
                        if (hasModel) {
                            var data = this.getView().byId("table").getModel().getData();
                            console.log(data);
                    ...
                    tblColumns: function() {
                        var col = this.getView().byId("table");

                        var col1 = this.getView().byId("table").getColumns()[0];
                        var col2 = this.getView().byId("table").getColumns()[1];
                        col.sort([col1, col2]);
                        console.log(col);
                    },
                    ...
                    getIndex: function() {
                        var model = this.getView().byId("indexCombo").getModel().getData();
                        var key = this.getView().byId("indexCombo").getSelectedKey();
