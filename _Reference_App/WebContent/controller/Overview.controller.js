			...
			.extend(
				"reference.controller.Overview", {
					...
					onInit: function(evt) {
						...
						$.sap.Service_URL = location.hostname === "localhost" ? "proxy/http/services.odata.org/V3/Northwind/Northwind.svc" :
							"/sap/opu/odata/sap/";
					...
					busy: function() {
						...
						busyIndicator.attachOpen(function() {
							...
							$(".sapUiLocalBusyIndicatorAnimation").append(
								"<section><img src='https://loading.io/spinners/comets/index.comet-spinner.svg'></section>");
					...
					openPDF: function() {
						var URL =
							"https://www.sapfioritrial.com/sap/opu/odata/sap/HCM_MY_PAYSTUBS_SRV/PDFPaystubs(SEQUENCENUMBER=1694,PersonnelAssignment='00100226')/$value";
