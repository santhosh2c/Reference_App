	...
	"use strict";
			...
			onInit : function(){
				// var sServiceUrl = "proxy/http/services.odata.org/V2/Northwind/Northwind.svc/$metadata";
				 var sServiceUrl = location.hostname === "localhost" ? "proxy/http/services.odata.org/V3/Northwind/Northwind.svc" : "/sap/opu/odata/sap/";
			...
			batch : function(){
				...
				var oModelResgCreate = new sap.ui.model.odata.ODataModel("proxy/http/172.16.213.16:8000/sap/opu/odata/sap/ZEMT_PMAPP_SRV/", {json:true});
